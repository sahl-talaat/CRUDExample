...
namespace CRUDTests
{
    public class CountriesServiceTest
    {
        ...
        // it should insert (add) the cointry ti the existing list of countries
        [Fact]
        public void AddCountry_ProperCountryDetails()
        {
            ...
            _contriesService.GetAllCountries();
        ...
        public void GetAllCountries_AddFewCountries()
        {
            ...
            foreach (CountryAddRequest country_request in country_request_list)
            {
                ...
                (_contriesService.AddCountry(country_request));
            }
        ...
        [Fact]
        // If we supply null ass CountryID, it should return null as CountryResponse
        public void GetCountryByCountryID_NullCountryID()
        {
            ...
            _contriesService.GetCountryByCountryID(countryID);
        ...
        [Fact]
        // If we supply a valid CountryID, 
        // it should return the matching country details as CountryResponse object
        public void GetCountryByCountryID_ValidCountryID()
        {
            ...
            _contriesService.AddCountry(country_add_request);

            // Act
            CountryResponse? country_response_from_get =
            _contriesService.GetCountryByCountryID(country_response_from_add.CountryID);
